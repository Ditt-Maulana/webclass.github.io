...
const Schedule = () => {
    ...
    piketGroup = [
        ["RINO", "AGUS", "SYAHRANI", "NABILA", "SANTI", "ANIN", "RIRIN"], // Senin
        ["NILAM", "RISA", "ANDINI", "RANGGA", "INSAN", "THALIA"], // Selasa
        ["SHEVA", "IMAN", "SHIVA", "TUTIK", "SELLA", "PUTRI F"], // Rabu
        ["AURA", "NUZULA", "FADILA", "SULAI", "AUFA", "NISA"], // Kamis
        ["NADIA", "BAGAS", "PUTRI A", "WIDYA", "PUTRA", "ARDI"], // Jumat
    ]
